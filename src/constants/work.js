...
export const work = [
    {
      ...
      bulletTwo: '  Addressed regular production bugs and improvements in existing Ruby application using Jira Software to prioritize requirements and utilizing CI/CD pipelines to rapidly iterate',
      bulletThree: '  Used Rails Internationalization (I18n) library for interpolation and creating custom localizations to build application in English and French; increased customer satisfaction by over 60%',
      image: esm,
      id: 0,
    },
    {
